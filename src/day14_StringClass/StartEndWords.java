...
and check if last letter of first word
and first letter of second work are same.
 if either one not 5 chars length: print
 "need to be exactly 5 chars length"
 if last letter of 1st word and
 first letter of 2nd word match:  print "Fizz"
 if they do not match:  print "Buzz - did not match"

    pre-condition: both words MUST have exactly 5 characters
 ...
 */
        ...
        if(length1 == 5 && length2 == 5){ // pre-condition
